...
public class AlbumSongsActivity extends AppCompatActivity implements AllSongsAdapter.RecyclerViewClickListener{
    ...
    private void initAlbumSongsActivity()
    {
        ...
        builderSingle.setAdapter(
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        {
                            Toast.makeText(AlbumSongsActivity.this, "Upcoming song: " + songTitle, Toast.LENGTH_SHORT).show();
                        }
                        else if (strName == "Add To Playlist")
                        {
                            utils.CreatePlaylistMenu(AlbumSongsActivity.this, songID);
                        }
                        else if (strName == "Rename")
                        {
                            utils.RenameSong(AlbumSongsActivity.this, musicSrv, adapter, isCurrentlyPlaying(pos), pos, songTitle, songArtist, songAlbum, songID);
                        }
                        else if (strName == "Set As Ringtone")
                        {
                            utils.SetRingtone(AlbumSongsActivity.this, songTitle, songPath);
                        }
                        else if (strName == "View Details")
                        {
                            utils.ViewDetails(AlbumSongsActivity.this, songTitle, songArtist, songAlbum, songPath);
                        }
                        else if (strName == "Delete")
                        {
                            utils.DeleteSong(AlbumSongsActivity.this, musicSrv, songList, adapter, pos, songTitle, songID);
                        }
